...
- **Batch Intake Protocol**: When the user asks to 'Process new books', execute `python .agent/skills/process-inbox.py`. Report the results table and confirm quarantined binaries in `inbox/processed/`.
